...
public class Mua {
	...
	private String taiKhoanNguoiMua;
	private String hoTenNguoiMua;
	private String dienThoaiNguoiMua;
	private String emailNguoiMua;
	private int maTinhNguoiMua;
	private int namSinhNguoiMua;
	private String tenTinhNguoiMua;
	...
	public void setMaMua(String maMua) {
		this.maMua = maMua;
	}
	...
	public String getTaiKhoanNguoiMua() {
		return taiKhoanNguoiMua;
	}
	public void setTaiKhoanNguoiMua(String taiKhoanNguoiMua) {
		this.taiKhoanNguoiMua = taiKhoanNguoiMua;
	}
	...
	public int getMaTinhNguoiMua() {
		return maTinhNguoiMua;
	}
	public void setMaTinhNguoiMua(int maTinhNguoiMua) {
		this.maTinhNguoiMua = maTinhNguoiMua;
	}
	public int getNamSinhNguoiMua() {
		return namSinhNguoiMua;
	}
	public void setNamSinhNguoiMua(int namSinhNguoiMua) {
		this.namSinhNguoiMua = namSinhNguoiMua;
	}
	public String getTenTinhNguoiMua() {
		return tenTinhNguoiMua;
	}
	public void setTenTinhNguoiMua(String tenTinhNguoiMua) {
		this.tenTinhNguoiMua = tenTinhNguoiMua;
	}
	public String getAnhNguoiMua() {
		return anhNguoiMua;
	}
	public void setAnhNguoiMua(String anhNguoiMua) {
